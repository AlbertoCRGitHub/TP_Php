...
<body>
    ...
    <div  style=" margin-left:20px; ">
        ...
        <form id="form" method="GET" action="estimate.php">
            <label for="categorie">Durée (en jours): </label>             <!--style="background:lime"-->
            <input type="number" name="jours" value= <?=$jours?>  min="1" max="30"  oninput="changeCouleur()" required> <br/><br/>
    ...
    <script>
        ...
        function setSelectedIndex(s, valsearch) //funcion para cuando Boton modifier se ponga la categoria que estaba A W P
        {
